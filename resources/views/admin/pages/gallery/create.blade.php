...
<div class="card mb-4">
    <div class="card-header">
        <div class="row">
            <div class="col-6">
                <a href="{{ url('/a/gallery') }}" class="btn btn-primary btn-sm">Back</a>
            </div>
    ...
    <div class="card-body">
        {!! Form::open(array('url' => 'a/gallery/images-save', 'method' => 'POST', 'files' => true, 'class' => 'dropzone', 'id' => 'my-dropzone')) !!}
